...
How can I call those in the Console, or later on in an R code chunk, which is expecting R? use `py$object_name` to make sure that R knows you're looking for a Python variable. For example, after running the code chunk above,
