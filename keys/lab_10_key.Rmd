...
subtitle: "SQL and Python examples in R Markdown"
...
### SQL in R Markdown with `RSQLite` package
...
1. In your project, create a subfolder of 'data' called 'sf_salaries', and drop the *sf_salaries_database.sqlite* file into it. 
