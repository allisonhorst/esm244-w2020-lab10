...
subtitle: "JSONs, databases, SQL and Python in R Markdown"
...
### A. Working with JSONs in R Markdown

- JSON: JavaScript Object Notation
- Machine + human readable data 

Maybe the hardest part: **How do I pronounce that?** (Jay-Sawn, Jason, J-S-O-N?) 
Answer: **It doesn't matter** (according to [Douglas Crockford](https://www.youtube.com/watch?v=zhVdWQWKRqM), and he should know...).

We'll use [this JSON data](https://data.lacity.org/api/views/kkrh-b4e3/rows.json?accessType=DOWNLOAD) for community GHG emissions (LA), already added in `data/la_ghg.json`. [Click here](https://catalog.data.gov/harvest/object/e909b39d-0671-4fa5-ae43-ddee8ebbd776) for metadata. 

### B. SQL in R Markdown with `RSQLite`
